...
7. **#46 (เห็นเพื่อนลอย)** — ทับกับ item #2 ในเอกสารเก่า `zyra-doc/issus/ai100-feedback-2026-07-21.md` (เคย fix แล้ว 2026-07-21) → อาจเป็น regression/อีก vector; **#45/#46/#47** ทีม mark เป็น In-Progress
