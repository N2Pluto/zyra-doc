...
- **PR:** ยังไม่ commit — รอ user สั่ง (worktree `<scratchpad>/zyra-app-pet`, ใหม่ 9 ไฟล์ แก้ 7)
- **ต่อจากนี้:** commit + PR → develop (ต้อง merge zyra-api #65 ก่อนถึงจะใช้บน dev ได้) → PR 7 zyra-ws forward `pet_*` → PR 10 member endpoint → wire VO
