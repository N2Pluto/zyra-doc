...
| 3 | ~~**ลูบหัวได้ XP ไหม** (card: 5 ครั้ง/วัน)~~ **ปิดแล้ว 2026-09-08 (รอบ 76)** | เดิม: `xp_play_with_pet` ปิดใน config v13 และ `times` = 1 · ตอนนี้: เปิดแล้ว (config v14) — ลูบ = **+1 XP ต่อคน ไม่มีเพดานรายวัน** จำกัดด้วย cooldown **1 ชั่วโมง/คน/pet** เท่านั้น | ไม่ต้องเคาะแล้ว — user ตัดสิน 2026-09-08 (api #102 / app #326) |
...
| XP config ที่ใช้อยู่ | ~~v13~~ → **v14** (2026-09-08, mig 97) · threshold 100/500/2000 · mood 12h/48h/72h · เปิด 6 activity · `xp_play_with_pet` **เปิดแล้ว** (1 XP/คน · ไม่มีเพดานรายวัน · cooldown 1 ชม.) |
