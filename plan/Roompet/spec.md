...
> **เหลืออะไร (2026-09-04):** ~~จ่าย XP ของอีก 9 activity~~ ✅ **เสร็จแล้ว** ([api #75](https://github.com/Maximumsoft-Co-LTD/zyra-api/pull/75) — ครบทั้ง 10 activity) · ที่เหลือ: เทส UI ในเบราว์เซอร์ · ตั้ง `xp_play_with_pet.times`=5 · Share flow · pet facing rows · `pet_sittable` · cron 09:00 ICT — รายการเต็มเรียงลำดับอยู่ใน [progress.md รอบ 21](progress.md)
