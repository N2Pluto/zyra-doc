...
| My location + การ์ด "Your weather" | ❌ | ✅ **(ยังไม่ทำ — ข้อ 56/42/45)** |
...
| **62** | **"My location" + การ์ด "Your weather"** อยู่ในเฟรม member เต็ม ๆ แต่ต้องมี location ราย user ที่ API ยังไม่มี และติดมติ PII (ข้อ 42/45) | **ไม่ทำในรอบนี้** — ทำแค่การ์ด workspace + 2 toggle ส่วนตัว |
