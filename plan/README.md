...
| [Roadmap](Roadmap/) | Admin ของ Roadmap/Zyra Spotlight — จัดการฟีเจอร์บนไทม์ไลน์ + scene editor (วาง object, อัปโหลด sprite) | UI + API ต่อกันแล้ว 2026-09-17 · `zyra-api@feat/admin-roadmap-api` + `zyra-app@feat/admin-product-updates` (ยังไม่ commit) · ตารางขึ้น dev แล้ว · landing ยังไม่ต่อ |
