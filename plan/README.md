...
| [Roadmap](Roadmap/) | Admin ของ Roadmap/Zyra Spotlight — จัดการฟีเจอร์บนไทม์ไลน์ + scene editor (วาง object, อัปโหลด sprite) | UI-only เสร็จ 2026-09-17 บน `feat/admin-product-updates` (ยังไม่ commit) · ข้อมูลเป็น mock ยังไม่มี API/spec |
