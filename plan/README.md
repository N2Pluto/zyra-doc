...
| [\[Feature\] Nature Object Management](<[Feature] Nature Object Management — Object Management/>) | SC-OBJ-NAT-01 — เพิ่ม Object Type "Nature" (ต้นไม้/พุ่มไม้/ดอกไม้) ใน Object Management (Admin) เดิม — animated spritesheet ต่อ animation state, weather-reactive intensity, walkable เสมอ — spec + technical design (schema `tb_object_animation`, API contract, realtime broadcast) + ux-ui-plan (ถอด Figma ครบ 8 section) + test-plan + progress | **UI ครบทุก node แล้ว — เหลือเปิดดูด้วยตา** · 2026-09-22 · ClickUp [86d446fw1](https://app.clickup.com/t/86d446fw1) · schema + API + UI ตาม Figma ครบ (migration `105`/`106`, endpoint `/animations`, upload modal, preview modal, tree card, error toasts, replace dialog) · PR: [api#130](https://github.com/Maximumsoft-Co-LTD/zyra-api/pull/130) · [api#131](https://github.com/Maximumsoft-Co-LTD/zyra-api/pull/131) · [app#425](https://github.com/Maximumsoft-Co-LTD/zyra-app/pull/425) · [app#426](https://github.com/Maximumsoft-Co-LTD/zyra-app/pull/426) · [app#427](https://github.com/Maximumsoft-Co-LTD/zyra-app/pull/427) · [app#429](https://github.com/Maximumsoft-Co-LTD/zyra-app/pull/429) · [app#432](https://github.com/Maximumsoft-Co-LTD/zyra-app/pull/432) · **เหลือ:** เปิด `/admin/object-management` ดูด้วยตา (ต้อง login) · §14.1 ข้อ 12 weather mapping รอ PM · แก้ spec ใน ClickUp 4 จุดให้ตรงมติ |
