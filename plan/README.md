...
| [\[Feature\] Nature Object Management](<[Feature] Nature Object Management — Object Management/>) | SC-OBJ-NAT-01 — เพิ่ม Object Type "Nature" (ต้นไม้/พุ่มไม้/ดอกไม้) ใน Object Management (Admin) เดิม — animated spritesheet ต่อ animation state, weather-reactive intensity, walkable เสมอ — spec + technical design (schema `tb_object_animation`, API contract, realtime broadcast) + ux-ui-plan (ถอด Figma ครบ 8 section) + test-plan + progress | **Implementing — 3 PR แรกเปิดแล้ว ยังไม่ merge** · 2026-09-20 · ClickUp [86d446fw1](https://app.clickup.com/t/86d446fw1) · schema blocker ทั้ง 5 ข้อเคาะแล้ว (required=idle เดียว, ไม่มี custom, ไม่มี frame config UI ฯลฯ) · PR: [zyra-api#130](https://github.com/Maximumsoft-Co-LTD/zyra-api/pull/130) migration 105/106 · [zyra-app#425](https://github.com/Maximumsoft-Co-LTD/zyra-app/pull/425) แก้บั๊ก collision default (วัด prod 2,453 placement) · [zyra-app#426](https://github.com/Maximumsoft-Co-LTD/zyra-app/pull/426) เพิ่ม nature เข้า enum/badge/filter |
