...
| 4387:121093 Marker menu (stage row) | แถวไอคอน 4 stage (egg / baby / adult / evolved) 24×24 gap-2 ใน `#242B32` radius 8 p-1 — stage ปัจจุบัน opacity 100 ที่เหลือ 50 % | ✅ **ทำแล้ว 2026-09-07** (app #291) — เลือกแล้ว XP รีเซ็ตไปต้นช่วง · ถามยืนยันถ้าทีมทำ XP ไปแล้ว (ไม่ใช้เงื่อนไข "ทีมเคยถึง stage นั้น" — user เคาะให้ปรับได้เลย) |
