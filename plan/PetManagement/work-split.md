...
| **11** `feat(app): render pet ใน VO` | AI — ✅ **merged 2026-09-04** [zyra-app #248](https://github.com/Maximumsoft-Co-LTD/zyra-app/pull/248) `357a61b` (live-test production build ผ่าน) | render pet บน VO scene ฝั่ง member · เล่น animation ตาม stage/mood · ลำดับแถว direction ต้อง import จาก `AVATAR_DIR_ROW` | "เกณฑ์ก่อนเปิด Feature Flag" ระบุ "render ตาม stage/mood" แต่ PR 8 คือ Map Editor เท่านั้น · ข้อสมมติลำดับแถว (`0=down 1=left 2=right 3=up`) **ยังไม่มีใครใช้ = ยังไม่เคยพิสูจน์กับ sprite จริง** |
